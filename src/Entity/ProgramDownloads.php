...
class ProgramDownloads
{
  ...
  public function setDownloadedAt(?DateTime $downloaded_at)
  {
  ...
  public function setCountryName(?string $country_name)
  {
  ...
  public function setRecommendedByPageId(int $recommended_by_page_id)
  {
  ...
  public function setRecommendedByProgram(Program $recommended_by_program)
  {
