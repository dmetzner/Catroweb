...
class ProgramRemixRelation implements ProgramRemixRelationInterface, ProgramCatrobatRemixRelationInterface
{
  ...
  public function setAncestor(Program $ancestor): ProgramRemixRelation
  {
  ...
  public function setDescendant(Program $descendant): ProgramRemixRelation
  {
  ...
  public function setDepth(int $depth): ProgramRemixRelation
  {
  ...
  public function setCreatedAt(DateTime $created_at): ProgramRemixRelation
  {
  ...
  public function setSeenAt(?DateTime $seen_at): ProgramRemixRelation
  {
