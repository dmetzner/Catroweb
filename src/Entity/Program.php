...
class Program
{
   ...
   * @ORM\Column(type="datetime", nullable=true)
   */
  protected ?DateTime $apk_request_time;
  ...
  public function setUploadIp(string $uploadIp)
  {
  ...
  public function setCategory(?StarterCategory $category)
  {
    $this->category = $category;
  }

  public function setExtractedDirectoryHash(?string $directory_hash)
  {
  ...
  public function setGamejamSubmissionAccepted(bool $accepted)
  {
    $this->gamejam_submission_accepted = $accepted;
  }
  ...
  public function setGameJamSubmissionDate(?DateTime $date)
  {
  ...
  public function setLikes(Collection $likes)
  {
    $this->likes = $likes;
  }
