...
class ProgramController extends AbstractController
{
   ...
   * @throws OptimisticLockException
   */
  private function checkAndAddViewed(Request $request, Program $program, array $viewed, ProgramManager $program_manager)
  {
  ...
  private function findUserPrograms(?User $user, Program $program)
  {
    $user_programs = null;
    if (null !== $user)
    {
