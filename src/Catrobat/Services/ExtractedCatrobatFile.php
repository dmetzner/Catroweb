...
class ExtractedCatrobatFile
{
  ...
  public function isFileMentionedInXml($filename): bool
  {
  ...
  private function getObject($objectTree): ?CodeObject
  {
  ...
  private function createDirectoryInSceneIfNotExist(string $base_path, string $dir_regex, string $dir_name)
  {
