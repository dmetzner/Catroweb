...
class GenerateTestDataCommand extends Command
{
   ...
   * @throws Exception
   */
  protected function extractBaseTestProgram(string $directory)
  {
   ...
   * @throws Exception
   */
  protected function extractEmbroideryTestProgram(string $directory)
  {
   ...
   * @throws Exception
   */
  protected function extractExtensionTestProgram(string $directory)
  {
  ...
  protected function generateProgramWithExtraImage(string $directory)
  {
  ...
  protected function generateProgramWithManualScreenshot(string $directory)
  {
    $this->filesystem->mirror($this->extracted_source_program_directory, $this->target_directory.$directory);
  ...
  protected function generateProgramWithScreenshot(string $directory)
  {
    $this->filesystem->mirror($this->extracted_source_program_directory, $this->target_directory.$directory);
  ...
  protected function generateProgramWithRudeWordInDescription(string $directory)
  {
    $this->filesystem->mirror($this->extracted_source_program_directory, $this->target_directory.$directory);
  ...
  protected function generateProgramWithRudeWordInName(string $directory)
  {
    $this->filesystem->mirror($this->extracted_source_program_directory, $this->target_directory.$directory);
    $properties = @simplexml_load_file($this->target_directory.$directory.'/code.xml');
  ...
  protected function generateProgramWithTags(string $directory)
  {
    $this->filesystem->mirror($this->extracted_source_program_directory, $this->target_directory.$directory);
    $properties = @simplexml_load_file($this->target_directory.$directory.'/code.xml');
  ...
  protected function generatePhiroProgram(string $directory)
  {
    $this->filesystem->mirror($this->extracted_source_program_directory, $this->target_directory.$directory);
    file_put_contents($this->target_directory.$directory.'/permissions.txt', "TEXT_TO_SPEECH\nBLUETOOTH_PHIRO\nVIBRATOR");
  }

  protected function generateLegoProgram(string $directory)
  {
    $this->filesystem->mirror($this->extracted_source_program_directory, $this->target_directory.$directory);
    file_put_contents($this->target_directory.$directory.'/permissions.txt', "TEXT_TO_SPEECH\nBLUETOOTH_LEGO_NXT\nVIBRATOR");
  }
