...
class ConsoleProgressIndicator
{
  ...
  public function isSuccess(string $msg = '')
  {
    if ('' == $msg)
    {
  ...
  public function isFailure(string $msg = '')
  {
    if ('' == $msg)
    {
  ...
  public function setInlineLimit(int $inline_limit)
  {
  ...
  public function setEnableErrorFile(bool $enable_error_file)
  {
    $this->enable_error_file = $enable_error_file;
  }
  ...
  public function setOnSuccessMsg(string $on_success_msg)
  {
  ...
  public function setOnFailureMsg(string $on_failure_msg)
  {
  ...
  public function setErrorPrintLimit(int $error_print_limit)
  {
