...
class CommandHelper
{
  ...
  public static function executeShellCommandLegacy(string $command, array $config, string $description = '',
                                             OutputInterface $output = null): bool
  {

    self::executeShellCommand(explode(" ", $command), $config, $description, $output);
  }
}
