    ...
    switch ($category) {
      ...
      case 'more_from_user':
        ...
        if (null !== $user && $user->getId() === $project_user_id) {
          $projects = $this->project_manager->getUserPrograms($project_user_id, false, $max_version, $limit, $offset);
        } else {
          $projects = $this->project_manager->getPublicUserPrograms($project_user_id, false, $max_version, $limit, $offset);
        }
